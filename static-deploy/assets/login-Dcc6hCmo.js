...
import { u as y } from "./AuthContext-CUPKj7Oa.js";
import { u as k } from "./index-CiN_UGES.js";
import { M as C, L as S, E } from "./mail-DF0SJfJQ.js";
import { E as P } from "./eye-DHw6EaHY.js";
import { C as L } from "./circle-alert-DukOSXm-.js";
import { C as D } from "./circle-check-big-DrBycU0f.js";
import "./createLucideIcon-iNHoReR6.js";
function U() {
  const { t: s } = v(),
    { login: g, user: c } = y(),
    n = k(),
    [a, f] = t.useState({ email: "", password: "" }),
    [i, b] = t.useState(!1),
    [d, m] = t.useState(!1),
    [x, l] = t.useState(""),
    [u, p] = t.useState("");
  ...
  const h = (o) => {
      const { name: r, value: w } = o.target;
      f((N) => ({ ...N, [r]: w })), l("");
    },
    j = async (o) => {
      o.preventDefault(), m(!0), l(""), p("");
      try {
        const r = await g(a.email, a.password);
        r.success
          ? (p("로그인 성공! 대시보드로 이동합니다..."),
            setTimeout(() => {
              n("/dashboard");
            }, 1e3))
          : l(r.error || "로그인에 실패했습니다.");
      } catch {
        l("네트워크 오류가 발생했습니다.");
      } finally {
        m(!1);
        ...
        e.jsxs("div", {
          ...
          children: [
            ...
            e.jsx("h2", {
              ...
              children: s("login.title", "벅스에 로그인"),
            }),
            e.jsx("p", {
              className: "text-purple-100",
              children: s(
                "login.subtitle",
                "음악이 필요한 순간, 벅스와 함께하세요"
              ),
            }),
          ],
        }),
                ...
                e.jsxs("div", {
                  children: [
                    e.jsx("label", {
                      htmlFor: "password",
                      className: "block text-sm font-medium text-gray-700 mb-2",
                      children: s("login.password", "비밀번호"),
                    }),
                    e.jsxs("div", {
                      className: "relative",
                      children: [
                  ...
                  children: d
                    ? e.jsxs("div", {
                        ...
                        children: [
                          ...
                          e.jsx("span", {
                            children: s("login.loggingIn", "로그인 중..."),
                          }),
                        ],
                      })
                    : s("login.submit", "로그인"),
            ...
            e.jsxs("div", {
              ...
              children: [
                ...
                e.jsx("a", {
                  ...
                  children: s("login.forgotPassword", "비밀번호를 잊으셨나요?"),
                }),
              ],
            }),
          ],
        ...
        e.jsxs("div", {
          ...
          children: [
            e.jsx("h3", {
              ...
              children: s("login.vipPromo", "벅스 VIP 멤버십"),
            }),
            e.jsx("p", {
            ...
            e.jsx("a", {
              href: "/membership",
              className:
                "inline-flex items-center px-4 py-2 bg-white/20 text-white rounded-lg hover:bg-white/30 transition-colors text-sm font-medium",
              children: s("login.learnMore", "자세히 보기"),
            }),
          ],
        }),
      ],
