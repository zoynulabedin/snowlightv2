...
import { u as j } from "./LanguageContext-BFw3fmyY.js";
import { C as f } from "./calendar-CmJUhcwv.js";
import { H as l } from "./heart-Dn2OeVKi.js";
import { S as N } from "./star-W7y2fMPn.js";
import { U as v } from "./users-ChKsnVKg.js";
import { c as p } from "./createLucideIcon-iNHoReR6.js";
import { G as x } from "./gift-e6xtNJXd.js";
import { C as w } from "./clock-CDLMwhTV.js";
/**
  ...
  const { t } = j(),
    ...
    c = [
      ...
      },
      {
        ...
        progress: 1,
        maxProgress: 3,
        icon: e.jsx(N, { className: "w-5 h-5" }),
      },
      {
        id: "4",
      ...
      },
      {
        ...
        progress: 23,
        maxProgress: 50,
        icon: e.jsx(k, { className: "w-5 h-5" }),
      },
      {
        id: "6",
        ...
        progress: 1,
        maxProgress: 3,
        icon: e.jsx(x, { className: "w-5 h-5" }),
      },
    ],
    o = [
      {
    ...
    g = (s) => {
      const a = c.find((i) => i.id === s);
      a && !a.completed && d((i) => i + a.hearts);
    },
    b = (s) => {
      const a = o.find((i) => i.id === s);
      a &&
        a.available &&
        r >= a.cost &&
        (d((i) => i - a.cost), alert(`${a.title} 교환이 완료되었습니다!`));
    },
    u = (s) => {
      switch (s) {
        case "daily":
  ...
  return e.jsx("div", {
    ...
    children: e.jsxs("div", {
      ...
      children: [
        e.jsxs("div", {
          ...
          children: [
            e.jsx("div", {
              ...
              children: e.jsx("div", {
                className:
                  "w-16 h-16 bg-gradient-to-r from-pink-500 to-red-500 rounded-full flex items-center justify-center",
                children: e.jsx(l, { className: "w-8 h-8 text-white" }),
              }),
            }),
            e.jsx("h1", {
              className: "text-3xl font-bold text-gray-900 mb-2",
              children: t("heartStation.title", "하트 충전소"),
            }),
            e.jsx("p", {
        ...
        e.jsx("div", {
          className:
            "bg-gradient-to-r from-Snowlight-pink to-pink-600 rounded-lg shadow-lg p-6 mb-8 text-white",
          children: e.jsxs("div", {
            ...
            children: [
              e.jsxs("div", {
                children: [
                  e.jsx("h2", {
                    ...
                    children: t("heartStation.myHearts", "내 하트"),
                  }),
                  e.jsxs("div", {
                    className: "flex items-center space-x-2",
                    children: [
                      e.jsx(l, { className: "w-6 h-6 fill-current" }),
                      e.jsx("span", {
              ...
              e.jsxs("div", {
                ...
                children: [
                  e.jsx("p", {
                    className: "text-pink-100 text-sm mb-1",
                    children: t("heartStation.todayEarned", "오늘 획득"),
                  }),
                  e.jsx("p", {
                    ...
                    children: e.jsxs("div", {
                      children: [
                        e.jsx("h3", {
                          ...
                          children: t(
                            "heartStation.availableMissions",
                            "진행 가능한 미션"
                          ),
                        }),
                        e.jsx("div", {
                                ...
                                children: [
                                  e.jsxs("div", {
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          ...
                                          e.jsxs("div", {
                                            children: [
                                              ...
                                              e.jsx("span", {
                                                className: `inline-block px-2 py-1 text-xs rounded-full ${u(
                                                  s.type
                                                )}`,
                                                children:
                                                  s.type === "daily"
                                      ...
                                      e.jsxs("div", {
                                        className:
                                          "flex items-center space-x-1 text-Snowlight-pink",
                                        children: [
                                          e.jsx(l, {
                                    ...
                                    e.jsxs("div", {
                                      ...
                                      children: [
                                        ...
                                        e.jsx("div", {
                                          ...
                                          children: e.jsx("div", {
                                            className:
                                              "bg-Snowlight-pink h-2 rounded-full transition-all",
                                            style: {
                                              width: `${
                                    ...
                                    children: [
                                      e.jsxs("div", {
                                        ...
                                        children: [
                                          ...
                                          e.jsx("span", {
                                            className: `inline-block px-2 py-1 text-xs rounded-full ${y(
                                              s.type
                                            )}`,
                                            children: s.type,
                                          }),
