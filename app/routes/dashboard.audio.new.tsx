  ...
  try {
    switch (action) {
      ...
      case "toggleApproval": {
        ...
        return json({ success: "Song approval status updated" });
      }
      ...
      case "bulkDelete": {
        ...
        return json({
          success: `${songIds.length} songs deleted successfully`,
        });
      }
...
export default function DashboardAudio() {
  ...
  const handleBulkAction = (action: string, value?: string) => {
    ...
    selectedSongs.forEach((id) => formData.append("songIds", id));
    if (value) formData.append("publish", value);
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={() => {
                    if (
                      confirm(`Delete ${selectedSongs.length} selected songs?`)
                    ) {
                        ...
                        {["ADMIN", "SUPER_ADMIN"].includes(user.role) && (
                          <Form method="post" className="inline">
                            ...
                            <button
                              ...
                              className="p-2 rounded hover:bg-gray-600 transition-colors"
                              title={song.isApproved ? "Unapprove" : "Approve"}
                            >
                              {song.isApproved ? (
