...
import { u as v } from "./LanguageContext-BFw3fmyY.js";
import { S as d } from "./search-eCLJacej.js";
import { F as j } from "./funnel-C-5Wa6A1.js";
import { C as y } from "./calendar-CmJUhcwv.js";
import { c as N } from "./createLucideIcon-iNHoReR6.js";
import { M as w } from "./message-circle-CUXJu09o.js";
import { S as C } from "./star-W7y2fMPn.js";
/**
    ...
    o = [
      ...m.filter((s) => {
        ...
        if (i) {
          ...
          return (
            s.albumTitle.toLowerCase().includes(a) ||
            s.albumArtist.toLowerCase().includes(a) ||
            s.reviewTitle.toLowerCase().includes(a) ||
            s.author.toLowerCase().includes(a)
          );
        }
        return !0;
      }),
      ...
      switch (c) {
        case "popular":
          return a.likes - s.likes;
        case "rating":
          return a.rating - s.rating;
        case "comments":
          return a.comments - s.comments;
        case "latest":
        default:
          return (
            new Date(a.publishDate).getTime() -
            new Date(s.publishDate).getTime()
          );
      }
    }),
    b = (s) =>
      Array.from({ length: 5 }, (a, r) =>
        e.jsx(
          ...
          {
            className: `w-4 h-4 ${
              r < s ? "text-yellow-400 fill-current" : "text-gray-300"
            }`,
          },
          r
        )
        ...
        e.jsxs("div", {
          ...
          children: [
            e.jsx("h1", {
              ...
              children: t("reviews.title", "추천 앨범 리뷰"),
            }),
            e.jsx("p", {
                ...
                e.jsxs("div", {
                  ...
                  children: [
                    ...
                    e.jsx("input", {
                      ...
                      className:
                        "w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-Snowlight-pink focus:border-transparent",
                    }),
                  ],
                }),
                e.jsx("div", {
                  ...
                  children: e.jsxs("div", {
                    ...
                    children: [
                      e.jsx(j, { className: "w-4 h-4 text-gray-500" }),
                      e.jsx("select", {
                        value: c,
                        onChange: (s) => x(s.target.value),
                        className:
                          "border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-Snowlight-pink focus:border-transparent",
                        children: g.map((s) =>
                          e.jsx(
                            "option",
                  ...
                  children: [
                        ...
                        e.jsxs("div", {
                          ...
                          children: [
                            e.jsx("h3", {
                              ...
                              children: s.albumTitle,
                            }),
                            e.jsx("p", {
                              className: "text-sm text-gray-600 truncate",
                              children: s.albumArtist,
                            }),
                            e.jsxs("div", {
                    ...
                    e.jsxs("div", {
                      ...
                      children: [
                        ...
                        e.jsx("p", {
                          className:
                            "text-gray-700 text-sm leading-relaxed line-clamp-3",
                          children: s.reviewContent,
                        }),
                      ],
                    }),
                    e.jsx("div", {
                      className: "flex flex-wrap gap-2 mb-4",
                      children: s.tags.map((a) =>
                        e.jsxs(
                          "span",
                          {
                            className:
                        ...
                        e.jsxs("div", {
                          ...
                          children: [
                            e.jsxs("div", {
                              ...
                              children: [
                                e.jsx(A, { className: "w-4 h-4 mr-1" }),
                                s.likes,
                              ],
                            }),
                            e.jsxs("div", {
          ...
          e.jsxs("div", {
            ...
            children: [
              e.jsx("div", {
                ...
                children: e.jsx(d, { className: "w-8 h-8 text-gray-400" }),
              }),
              e.jsx("h3", {
                className: "text-lg font-medium text-gray-900 mb-2",
                children: t("reviews.noResults", "검색 결과가 없습니다"),
              }),
              e.jsx("p", {
                className: "text-gray-600",
                children: t(
        ...
        o.length > 0 &&
          e.jsx("div", {
            ...
            children: e.jsx("button", {
              className:
                "px-6 py-3 bg-white border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition-colors",
              children: t("reviews.loadMore", "더 많은 리뷰 보기"),
            }),
          }),
      ],
    }),
