...
export default function DashboardUsers() {
  const { users, search, roleFilter, currentUser } =
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">모더레이터</p>
                <p className="text-2xl font-semibold text-gray-900">
                  {roleStats.MODERATOR}
                </p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">슈퍼 관리자</p>
                <p className="text-2xl font-semibold text-gray-900">
                ...
                {currentUser.role === "SUPER_ADMIN" &&
                  ...
                  (adminPromoteConfirm === viewingUser.id ? (
                    <div className="ml-3 flex items-center">
                      <Form method="post">
                        <input type="hidden" name="intent" value="make-admin" />
                        <input
                          type="hidden"
                          name="userId"
