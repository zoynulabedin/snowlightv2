...
export default function DashboardUsers() {
  const { users, search, roleFilter, currentUser, page, totalPages } =
            ...
            <div className="p-6">
              <Form
                ...
                onSubmit={(e) => {
                  ...
                  if (pageInput) (pageInput as HTMLInputElement).value = "1";
                }}
              >
          ...
          {totalPages > 1 && (
            ...
            >
              <button
                onClick={() => goToPage(1)}
                disabled={page === 1}
                className={`px-3 py-1 rounded-lg border text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 ${
                  page === 1
                ...
                {totalPages <= 7 ? (
                  Array.from({ length: totalPages }, (_, i) => i + 1).map(
                    (p) => (
                      <button
                        key={p}
                        onClick={() => goToPage(p)}
                        className={`px-2.5 py-1 rounded-md border text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 ${
                          page === p
                  ...
                  <>
                    {page > 2 && (
                      <button
                        onClick={() => goToPage(1)}
                        className="px-2.5 py-1 rounded-md border text-sm font-medium bg-white text-gray-700 border-gray-300 hover:bg-red-50 hover:text-red-600"
                      >
                        1
                      </button>
                    )}
                    ...
                    <button
                      className="px-2.5 py-1 rounded-md border text-sm font-medium bg-red-600 text-white border-red-600"
                      disabled
                    >
                      {page}
                    </button>
